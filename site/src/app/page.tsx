...
const STATS = [
  { value: "99.7%", label: "Recall rate", note: "152,300-record set", ref: true },
  { value: "31", label: "Countries", note: "Maintained rulesets", ref: false },
  { value: "99.8%", label: "Precision", note: "Same run", ref: true },
  { value: "1.6ms", label: "Per page", note: "Node, 2,000 chars", ref: true },
];
...
const CORE_FEATURES = [
  ...
  "346 pattern definitions, 44 checksum validators",
